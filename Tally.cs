...
namespace TallyConnector
{
    public class Tally : IDisposable
    {
                                                     ...
                                                     List<string> SystemFilters = null)
        {
            ...
            List<Group> TGroups = GroupsColl.Groups ?? new List<Group>();
            CLogger.TallyReqCompleted(ReqType);
            return TGroups;
        }
                                                       ...
                                                       List<string> SystemFilters = null)
        {
            ...
            Nativelist = Nativelist ?? new List<string>()
            {
                "Name",
                "GUID",
                "Masterid"
                                                               ...
                                                               List<string> SystemFilters = null)
        {
            ...
            Nativelist = Nativelist ?? new List<string>() { "Name", "GUID", "Masterid" };
            Filters = Filters ?? new List<string>() { "IsEmployeeGroup", "Payroll" };
            SystemFilters = SystemFilters ?? new List<string>() { "Not $ISEMPLOYEEGROUP", "Not $FORPAYROLL" };
                                                                  ...
                                                                  List<string> EmployeeGroupSystemFilters = null)
        {
            staticVariables = staticVariables ?? new StaticVariables() { SVCompany = Company, SVExportFormat = "XML" };
            Nativelist = Nativelist ?? new List<string>() { "Name", "GUID", "Masterid" };
            EmployeeGroupFilters = EmployeeGroupFilters ?? new List<string>() { "IsEmployeeGroup" };
            EmployeeGroupSystemFilters = EmployeeGroupSystemFilters ?? new List<string>() { "$ISEMPLOYEEGROUP" };
                                                            ...
                                                            List<string> EmployeeSystemFilters = null)
        {
            staticVariables = staticVariables ?? new StaticVariables() { SVCompany = Company, SVExportFormat = "XML" };
            Nativelist = Nativelist ?? new List<string>() { "Name", "GUID", "Masterid" };
            EmployeeFilters = EmployeeFilters ?? new List<string>() { "IsEmployeeGroup", "Payroll" };
            EmployeeSystemFilters = EmployeeSystemFilters ?? new List<string>() { "Not $ISEMPLOYEEGROUP", "$FORPAYROLL" };
                                          ...
                                          List<string> fetchList = null)
        {
            ...
            fetchList = fetchList ?? new List<string>() { "MasterId", "*" };
            StaticVariables sv = new StaticVariables() { SVCompany = company, SVFromDate = fromDate, SVToDate = toDate };
            List<string> Filters = new List<string>() { "Groupfilter" };
            List<string> SystemFilter = new List<string>() { $"${LookupField} = \"{LookupValue}\"" };
                                             ...
                                             string company = null)
        {
            ...
            groupEnvelope.Header = new Header(Request: "Import", Type: "Data", ID: "All Masters");
                                                   ...
                                                   List<string> Nativelist = null)
        {
            ...
            fromDate = fromDate ?? FromDate;
            toDate = toDate ?? ToDate;
            Nativelist = Nativelist ?? new List<string>() { "Address", "MasterId", "InterestCollection", "REMOTEGUID", "*" };
            StaticVariables sv = new StaticVariables() { SVCompany = company, SVFromDate = fromDate, SVToDate = toDate };
                                            ...
                                            List<string> Nativelist = null)
        {
            ...
            List<string> Filters = new List<string>() { "Cusfilter" };
                                            ...
                                            List<string> fetchList = null)
        {
            ...
            fetchList = fetchList ?? new List<string>() { "MasterId", "*" };
            StaticVariables sv = new StaticVariables() { SVCompany = company, SVFromDate = fromDate, SVToDate = toDate };
            List<string> Filters = new List<string>() { "Customfilter" };
            List<string> SystemFilter = new List<string>() { $"${LookupField} = \"{LookupValue}\"" };
                                                   ...
                                                   string company = null)
        {
            ...
            VchTypeEnvelope.Header = new Header(Request: "Import", Type: "Data", ID: "All Masters");
                                                ...
                                                List<string> fetchList = null)
        {
            ...
            fromDate = fromDate ?? FromDate;
            toDate = toDate ?? ToDate;
            fetchList = fetchList ?? new List<string>() { "*" };
            StaticVariables sv = new StaticVariables() { SVCompany = company, SVFromDate = fromDate, SVToDate = toDate };
                                                ...
                                                string company = null)
        {
            ...
            currencyEnvelope.Header = new Header(Request: "Import", Type: "Data", ID: "All Masters");
                                                      ...
                                                      string company = null)
        {
            ...
            AttendanceEnvelope AttndTypeEnvelope = new AttendanceEnvelope();
            AttndTypeEnvelope.Header = new Header(Request: "Import", Type: "Data", ID: "All Masters");
            AttndTypeEnvelope.Body.Desc.StaticVariables = new StaticVariables() { SVCompany = company };
                                 ...
                                 string viewname = null)
        {
            ...
            StaticVariables staticVariables = new StaticVariables() { SVCompany = company, SVFromDate = fromDate, SVToDate = toDate, SVExportFormat = "XML", ViewName = viewname };
